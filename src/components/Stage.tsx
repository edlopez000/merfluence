...
export function Stage({
  ...
  useEffect(() => {
    ...
    const onWheel = (event: WheelEvent) => {
      ...
      //
      // Returning without preventDefault is load-bearing, not incidental: the
      // moment this branch consumes the event, every diagram on the page becomes a
      // scroll trap that freezes the Confluence page around it. The gesture is
      // named in the zoom buttons' tooltips and the keyboard chip instead, neither
      // of which touches the wheel. test/view-app.test.jsx asserts the event goes
      // through uncancelled.
